...
def create_segmenter(hand=True):
    ...
    model_asset_path='selfie_multiclass_256x256.tflite' if hand else 'deeplab_v3.tflite'
...
def get_hand_results(image, detection_result):
    ...
    x_coordinates_list, y_coordinates_list, bbs = [], [], []
    ...
    return x_coordinates_list, y_coordinates_list, cropped_image, bbs
...
def detect_hand(image, segment=True):
    ...
    kpx2d, kpy2d, cropped_image, bb = get_hand_results(image, detection_result)
    ...
    return annotated_image, kpx2d, kpy2d, cropped_image, bb, masked_hand
